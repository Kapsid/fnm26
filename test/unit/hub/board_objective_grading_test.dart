...
void main() {
  ...
  test('the continental objective is graded once the cup has a champion',
      () async {
    ...
    final objectives =
        await container.read(cycleObjectivesProvider(career.id).future);
    ...
    final world =
        objectives.where((o) => o.tier == TournamentTier.world).single;
