...
void main() {
  test('the final is reported by the round popup, not skipped', () async {
    ...
    for (var i = 0; i < 400; i++) {
      ...
      final popup =
          await container.read(latestRoundPopupProvider(career.id).future);
      if (popup != null &&
          (stages.isEmpty || stages.last != '${popup.competition}/${popup.stage}')) {
