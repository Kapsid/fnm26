...
void main() {
  ...
  test('a tournament played to its end is talked about', () async {
    final career =
        (await container
    ...
    // The Nations Cup group: a finals tournament the nation is in from the
    // start. Playing every one of its matches ends the campaign, and a
    // campaign that ends in a group is a campaign that went out in the group.
    final group = [
