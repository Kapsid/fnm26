...
typedef NationIdentityData = ({String? nickname, NationStyle style, int pedigree});
...
abstract final class NationIdentity {
  ...
  static const NationIdentityData _default =
      (nickname: null, style: NationStyle.balanced, pedigree: 3);
  ...
  static const Map<String, NationIdentityData> _byCode = {
    ...
    'GER': (nickname: 'Die Mannschaft', style: NationStyle.highPress, pedigree: 1),
    'ITA': (nickname: 'Azzurri', style: NationStyle.defensive, pedigree: 1),
    'NED': (nickname: 'Oranje', style: NationStyle.highPress, pedigree: 1),
    'POR': (nickname: 'Seleção das Quinas', style: NationStyle.possession, pedigree: 1),
    ...
    'DEN': (nickname: 'Danish Dynamite', style: NationStyle.highPress, pedigree: 3),
    ...
    'POL': (nickname: 'Biało-czerwoni', style: NationStyle.counter, pedigree: 3),
    ...
    'ARG': (nickname: 'La Albiceleste', style: NationStyle.possession, pedigree: 1),
    ...
    'PER': (nickname: 'La Blanquirroja', style: NationStyle.possession, pedigree: 3),
    'ECU': (nickname: 'La Tri', style: NationStyle.physical, pedigree: 3),
    'PAR': (nickname: 'La Albirroja', style: NationStyle.defensive, pedigree: 3),

    // ---- North America ----------------------------------------------------
    'MEX': (nickname: 'El Tri', style: NationStyle.counter, pedigree: 2),
    'USA': (nickname: 'Stars and Stripes', style: NationStyle.direct, pedigree: 3),

    // ---- Africa -----------------------------------------------------------
    'SEN': (nickname: 'Lions of Teranga', style: NationStyle.physical, pedigree: 3),
    ...
    'CIV': (nickname: 'Les Éléphants', style: NationStyle.physical, pedigree: 3),
    'CMR': (nickname: 'Indomitable Lions', style: NationStyle.physical, pedigree: 3),
    ...
    'TUN': (nickname: 'Eagles of Carthage', style: NationStyle.defensive, pedigree: 3),
    'RSA': (nickname: 'Bafana Bafana', style: NationStyle.flair, pedigree: 4),

    // ---- Asia & Oceania ---------------------------------------------------
    'JPN': (nickname: 'Samurai Blue', style: NationStyle.possession, pedigree: 3),
    'KOR': (nickname: 'Taegeuk Warriors', style: NationStyle.highPress, pedigree: 3),
    'IRN': (nickname: 'Team Melli', style: NationStyle.defensive, pedigree: 3),
    'KSA': (nickname: 'The Green Falcons', style: NationStyle.possession, pedigree: 3),
